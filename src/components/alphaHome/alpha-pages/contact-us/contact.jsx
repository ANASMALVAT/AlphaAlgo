            ...
            <section class="bg-[#F5F5F5]">
                <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <div className=' flex text-xl gap-3 items-center mb-8'>   
                        <MailOutlineIcon fontSize='large'  className=' text-xl text-gray-900 '/>
                        <h2 class=" text-3xl tracking-tight font-extrabold text-left  text-gray-900">Contact Us</h2>
                    </div>
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div>
                            <label for="message" class="block mb-2 text-sm font-medium text-gray-800">Your Mail</label>
                            <input required type="email" id="email"  onChange={(e) => setEmail(e.target.value)}  class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:border-[#6c7af8] focus:ring-[#6c7af8]  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-300 dark:text-white  dark:shadow-sm-light placeholder:opacity-70 "  ></input>
                        </div>
                        <div>
                        <label for="message" class="block mb-2 text-sm font-medium text-gray-800">Subject</label>

...
const AlphaGptWindow = () => 
{
    ...
    return (
        ...
        <div style={{  whiteSpace: 'pre', scrollbarWidth: 'thin', scrollbarColor: '#4C5ADF #011627', fontFamily: 'monospace',  fontSize: '14px',fontColor: 'rgb(55,65,81)'}}
            className="alpha-screen mt-10  custom-scrollbar  hover:scale-[1.35] hover:duration-300  w-full h-[400px] p-2  border text-white rounded-[0.25rem] border-gray-700 bg-[#011627] text-left overflow-auto">

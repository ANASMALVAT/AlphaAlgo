...
const ComponentAlphaAlgo =  ({isOpen}) => (
  ...
  <Popup
    trigger = {
        <button className={`what-button overflow-hidden mt-6 mb-8 flex flex-row items-center text-center align-middle  rounded-sm px-6  font-mono font-normal justify-center text-white border hover:bg-gradient-to-r from-[#4C5ADF] to-[#4C5ADF] hover:duration-300 border-b-8 border-[#2d33ca]`}>
                    Explore 

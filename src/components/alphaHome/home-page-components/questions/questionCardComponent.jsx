    ...
    return(
        <div className="div-question  flex flex-col ">
            <div className="question-header common-margin-question mb-4">
                <h1 className="question-header-text text-algoblack font-semibold">Practice Algorithmic Questions</h1>
            </div>

            <div className=" question-text common-margin-question mb-10">
                <h2 className=" text-algoblack  question-text text-lg font-normal">

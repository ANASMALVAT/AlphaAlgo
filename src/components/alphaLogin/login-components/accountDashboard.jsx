...
import { toggelLoginWindowFalse, toggelLoginWindowTrue } from '../../../redux/slices/userLoginWindow';
...
const AccountDashboard = () => {
    ...
    <div className=' flex flex-col justify-top  min-h-screen  max-w-[1400px] m-auto px-4 mt-20 mb-10 '>
        <div className=' flex  flex-wrap xl:flex-row justify-evenly w-full  gap-6  '>
            <div className=' dashboard-navigation min-w-[220px] max-w-[220px] flex flex-col gap-2'>
                    <div className='  cursor-pointer w-full  mt-1 flex items-center p-2  text-algoblack gap-2 shadow-lg bg-transparet border-2 border-zinc-300 justify-center text-center p-2  rounded-md'>
                        <h1  className=' text-[22px] font-normal '>Dashboard</h1>
                    </div>
                <div className='  cursor-pointer w-full  mt-1 flex items-center p-2  text-algoblack gap-2 shadow-lg bg-transparet border-2 border-zinc-300 justify-center text-center p-2  rounded-md'>
                    <h1  className=' text-[22px] font-normal '>Purchases</h1>
                </div>
                <div onClick={() => logout()} className=' cursor-pointer w-full  mt-1 flex items-center p-2  text-white gap-2 shadow-lg bg-[#626EE3] border-2 border-zinc-300 justify-center text-center p-2  rounded-md'>
                    <h1  className=' text-[22px] font-normal '>Logout</h1>
                </div>
            </div>

            <div className=' profile-information flex flex-col gap-6  justify-center  mb-8'>

                <div className= ' flex  flex-col items-start justify-start  rounded-lg border border-gray-300 max-w-[600px] md:w-[500px] lg:w-[600px] xl:w-[600px] h-[400px] px-4 '>
                    ...
                    <div className=' account-detail mt-4'>
                ...
                <div className= ' flex  flex-col  items-start justify-start pt-4  rounded-lg border min-w-[370px] border-gray-300 max-w-[600px] md:w-[500px] lg:w-[600px] xl:w-[600px] h-[300px] px-4 '>
                    <div className=' w-full h-full'>
                        ...
                        <div className=' mt-8 flex items-start px-3 py-3 w-full pr-6  justify-between rounded-md  bg-[#EDF2F7]' >

...
const AlphaGptWindowText = ({ message, type }) => {
  ...
  return (
    <div className={`gpt-window-text flex-1 rounded-md flex mb-4 bg-transparent w-[full] font-mono ${type === 'user' ? 'flex-row-reverse' : 'flex-row-reverse'} border-b border border-gray-700 items-center`}>

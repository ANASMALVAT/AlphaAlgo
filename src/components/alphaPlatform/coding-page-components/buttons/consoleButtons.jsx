...
const ConsoleButton = ({setConsole,isConsole, setInput, isInput, setNote, isNote}) => {
    return (
        <>
           <button onClick={setConsole} className={` border border-[#1F2937] overflow-hidden flex flex-row items-center  rounded-[4px] px-2 py-2 font-sans text-sm font-normal text-white ${isConsole ? 'bg-[#3e49b4]'  : 'bg-[#5867ea]'}`}>

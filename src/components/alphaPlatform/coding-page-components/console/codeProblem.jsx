    ...
    return (
        <>
            <div className=" code-problem flex flex-col gap-2 h-full w-full whitespace-pre overflow-auto rounded-md ">
                ...
                <div className="mb-2">
                    <h1 className="problem-question text-2xl font-normal landing-relaxed text-gray-300 mb-4">
                        {problemName}
                    </h1>
                ...
                { problemExampleTwoInput &&
                    <div name ="example 2">
                    <h1 className=" problem-example text-xl antialiased  font-normal tracking-normal landing-relaxed text-white mb-3">Example</h1>
                    <div className="w-full mb-4">
                        <CodeBlock
                ...
                <div name = 'constraint' className="mb-4">

...
const AlphaGptWindowText = ({data,type}) =>{
    return (
        <div className={` gpt-window-text rounded-sm flex flex-row mb-4 bg-[#0e2b44]  w-[full] font-mono ${type === 'User' ? 'text-right'  : 'text-left'} border border-gray-700  items-center `}>
            ...
            <div className=' whitespace-pre-wrap text-data w-full  h-full p-4 text-left text-lg font-light tracking-tight text-[white] dark:text-white '>
                {data}
            </div>
        </div>
    )

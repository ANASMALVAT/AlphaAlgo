        ...
        <>
            <div className="flex flex-col w-full h-full items-center">
                ...
                <div className="flex flex-row justify-between items-center text-center mt-6 ">
                        <Link to="/" >
                            <button onClick={setWhiteBoard} className={`overflow-hidden rounded-sm w-32 mr-2 flex flex-row items-center  px-2 py-2 font-mono text-sm font-normal justify-center border-4 border-gray-600 text-white   hover:border-[#4C5ADF]`}>
                                Home 
                            </button>
                        </Link>
                </div>

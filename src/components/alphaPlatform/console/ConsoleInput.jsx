...
const ConsoleInput = ({output,handleCompile,showProblem}) =>{
    ...
    return (
        <div className="overflow-hidden flex flex-col w-full min-h-screen h-full p-1 border-2 border-[#1f2937]  bg-algoblack">

            <div className=" overflow-hidden  flex flex-row items-start space-x-1 mb-2 py-2 h-18 w-full bg-algoblack justify-start">
            ...
            <div className="h-full w-full min-h-screen overflow-hidden mb-2">
                {isInput   &&  <CustomInput/> }
            ...
            <div className="flex flex-row justify-start">
                ...
                <button onClick={showProblem} className={` overflow-hidden w-28 mr-2  flex flex-row items-center whitespace-nowrap rounded-md px-2 py-2 font-mono text-sm font-normal justify-center border border-[#1F2937] text-white hover:border hover:border-[#07A7C3]`}>
                    View Problem
                </button>

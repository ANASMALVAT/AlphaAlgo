...
const ConsoleInput = ({output}) =>{
    ...
    return (
        <div className="overflow-hidden flex flex-col w-full min-w-[250px] h-[50%] p-1 border-2 border-[#1f2937]  bg-[#12151D]">

            <div className=" overflow-hidden flex flex-row items-start space-x-1 py-2 h-12 w-full bg-[#12151D]">
                
                <button onClick={setConsole} className={`overflow-hidden flex flex-row items-center  rounded-sm px-2 py-2 font-mono text-sm font-normal tracking-wide text-white ${isConsole ? 'bg-[#1C283B]' : 'bg-[#12151D]'}`}>
                ...
                <button onClick={setInput} className={`overflow-hidden flex flex-row items-center rounded-sm px-2 py-2 font-mono text-sm font-normal tracking-wide text-white ${isInput ? 'bg-[#1C283B]' : 'bg-[#12151D]'}`}>
